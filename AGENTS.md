...
| 写 DP                               | [docs/dp-conventions.md](docs/dp-conventions.md)（设计规则）＋ [docs/conventions/dp-validation-conventions.md](docs/conventions/dp-validation-conventions.md)（校验与归一化）                                                                           |
| DP 校验 / 归一化                    | [docs/conventions/dp-validation-conventions.md](docs/conventions/dp-validation-conventions.md)（三入口职责 · 校验收敛 · 归一化细则）                                                                                                                    |
| DP JSON / 序列化                    | [docs/conventions/dp-json-conventions.md](docs/conventions/dp-json-conventions.md)（模式总表 · 类型映射 · BigDecimal DP 模式）                                                                                                                          |
| 新增字段类型                        | [docs/conventions/framework-type-contracts.md](docs/conventions/framework-type-contracts.md)（DP 清单表）＋ [docs/dp-conventions.md](docs/dp-conventions.md)                                                                                            |
...
| DP 必测分组 / 写 DP 测试            | [docs/conventions/dp-test-conventions.md](docs/conventions/dp-test-conventions.md)                                                                                                                                                                      |
...
| 错误结构                            | [ADR-0013 错误响应结构](docs/adr/0013-error-response-structure.md)＋`docs/conventions/aip-api-conventions.md` §8（错误处理）                                                                                                                            |
...
| 领域事件 / 事件载荷 / 投递时机      | `docs/conventions/framework-type-contracts.md`（DomainEvent 族节）＋ `docs/conventions/framework-crosscutting.md`（编排规范副作用条）＋ [ADR-0011 验证是独立于用户聚合的可复用领域概念](docs/adr/0011-verification-cross-module-domain.md)              |
| 敏感值 / DP 设计                    | [docs/dp-conventions.md](docs/dp-conventions.md)（敏感值与 Masked 族）                                                                                                                                                                                  |
...
| 终态守卫                            | `docs/conventions/framework-crosscutting.md`（终态守卫段）＋ [ADR-0017 聚合删除语义：终态迁移，领域无擦除](docs/adr/0017-aggregate-lifecycle-removal-semantics.md) / [ADR-0023 注销终态键释放与归档](docs/adr/0023-terminal-key-release-and-archive.md) |
| 条件请求 / If-Match / 乐观锁版本    | [ADR-0037 乐观锁版本校验收敛](docs/adr/0037-optimistic-lock-version-guard.md)＋`docs/conventions/framework-type-contracts.md`（Versioned / VersionAwareCommand 节）                                                                                     |
| 文档体系自身规范                    | `docs/doc-conventions.md`                                                                                                                                                                                                                               |
| 设计/评审 Controller 端点（写侧）   | `docs/conventions/aip-api-conventions.md` §2 资源 / §3 方法 / §4 字段 / §7 命名 / §8 错误处理 ＋ `docs/conventions/adapter.md`（WebAssembler 转换器）                                                                                                   |
| 设计/评审查询服务端点（读侧）       | `docs/conventions/aip-api-conventions.md` §2.2 集合路径 / §3.2 Get / §3.3 List / §5.1 分页 ＋ query-server 模块（混装）                                                                                                                                 |
