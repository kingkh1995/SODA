...
/**
 * 请求源 DP（2026-08-16，见 ADR-0026）— {@code {scene, subject}} 两个纯字符串属性。
 * <p>
 ...
 * <p>
 * {@link #compositeKey()} = {@code "scene:subject"} — {@code active_key} 单一事实源（取代
 * ADR-0025 的 infra {@code composeActiveKey} 单点函数，复合键推导是 DP 合法职责——
 * 非序列化：串从不解析回 DP，是单向派生的槽位唯一键）。
 * 不可变、自校验、可比较。
 *
 * @see Type
 */
