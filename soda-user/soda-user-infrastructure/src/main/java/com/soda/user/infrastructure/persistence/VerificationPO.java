 ...
 * <p>
 * 与领域 {@code Verification}（单类 + source/recipient 双概念，2026-08-16，见 ADR-0026）双向
 * 转换见 {@link com.soda.user.infrastructure.convertor.VerificationConvertor}；restore 走
 * {@code channel} + {@code target} 两列（2026-08-16 修订：替代 recipient 自描述单列，见 ADR-0026
 ...
 * 由 Spring Data auditing 维护（@CreatedDate/@LastModifiedDate），应用恒填充，无 DB 默认值（见 ADR-0023）。
 */
@Entity
@Table(
        name = "verification",
