 ...
 * 各自校验规则后通过 {@link #of(CharSequence)} 创建，再传递给 {@link com.soda.component.domain.gateway.CredentialHasher}。
 * <p>
 * 安全约定（应用层负责）：
 * <ul>
 *   <li>不写入日志</li>
...
public final class RawCredential extends Secret {
    ...
    /**
     * 读取内部值。仅限 {@link com.soda.component.domain.gateway.CredentialHasher} 使用。
